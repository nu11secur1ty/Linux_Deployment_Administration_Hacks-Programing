# Uderstanding CPU Load Average

Hello friends, this table will be helping you to calculate your CPU Loading Average depends on what you want to run on your Linux Server, and how many Cores you use!
