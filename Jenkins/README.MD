...
```
- Edit:
. Change the variable content, with your content `NAME=yourname`
. Edit this `JENKINS_HOME=/var/lib/$NAME` line and add in this line your path of your `root` directory `/your/path/$PATH`
